...
All_75 <- Fxn_IntegrativeSavannaTopkillModel(Runs_Set = Runs, Trees = Trees, TL = 70,
                                          GrowthFlat = "Positive",
                                          IntensityFlat = FALSE,
                                          FireFrequencyFlat = FALSE,
                                          FileName = "All")
...
pEscape_All_100 <- Summary_pEscape(GrowthNegative,MAP_low = MAP_low, MAP_high = MAP_high, MAP_sequence = MAP_seq)
